 ...
 * designed. Based on Bucci's sample
 *
...
public abstract class StackTest {
    ...
    private Stack<String> createFromArgsTest(String... args) {
        Stack<String> argStack = this.constructorTest();
    ...
    private Stack<String> createFromArgsRef(String... args) {
        Stack<String> argStack = this.constructorRef();
    ...
    @Test
    public final void testPushHello() {
        /*
         * Set up variables
         */
        Stack<String> s = this.createFromArgsTest();
    ...
    @Test
    public final void testPushEmptyStackEmptyArg() {
        /*
         * Set up variables
         */
        Stack<String> s = this.createFromArgsTest();
    ...
    @Test
    public final void testPushHelloThere() {
        /*
         * Set up variables
         */
        Stack<String> s = this.createFromArgsTest("there");
        Stack<String> sExpected = this.createFromArgsRef("hello", "there");
        /*
         * Call method under test
         */
        s.push("hello");
