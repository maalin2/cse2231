...
public abstract class SetTest {
    ...
    public void testContainsRoutine() {
        ...
        assertEquals(t1.contains("a"), true);
    }
    ...
    public void testRemoveChallenge() {
        Set<String> t1 = this.createFromArgsTest("a", "b", "c", "d", "e");
        Set<String> t2 = this.createFromArgsRef("b", "c", "d", "e");
        String removed = t1.remove("a");
        assertEquals(t1, t2);
    }
    ...
    public void testAddRoutine() {
        Set<String> t1 = this.createFromArgsTest("a", "b");
        Set<String> t2 = this.createFromArgsRef("a", "b", "c");
        t1.add("c");
        assertEquals(t1, t2);
    }
    ...
    public void testAddChallenge() {
        final int aUpperAscii = 65;
        Set<String> t1 = this.createFromArgsTest("a");
        Set<String> t2 = this.createFromArgsRef("a",
                Character.toString((char) aUpperAscii));
        t1.add(Character.toString((char) aUpperAscii));
        assertEquals(t1, t2);
    }
