...
public class List3<T> extends ListSecondary<T> {
    ...
    public final void addRightFront(T x) {
        ...
        Node rightFront = new Node();
        Node nextRight = this.lastLeft.next;

        rightFront.data = x;
        rightFront.next = nextRight;
        rightFront.previous = this.lastLeft;

        this.lastLeft.next = rightFront;
        nextRight.previous = rightFront; // no if statements needed
    ...
    public final T removeRightFront() {
        ...
        Node nextRight = rightFront.next;

        T removed = rightFront.data;

        this.lastLeft.next = nextRight;
        nextRight.previous = this.lastLeft;
    ...
    public final void advance() {
        assert this.rightLength() > 0 : "Violation of: this.right /= <>";
        Node nextNode = this.lastLeft.next;
        this.lastLeft = nextNode;
    ...
    public final void moveToFinish() {
        Node lastNode = this.postFinish.previous;
    ...
    public final void retreat() {
        ...
        Node prevNode = this.lastLeft.previous;
        this.lastLeft = prevNode;
