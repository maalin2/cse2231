...
public abstract class StatementTest {
     ...
     *
     */
    private static final String FILE_NAME_4 = "data/statement-sample4.bl";
    ...
    public final void testAddToBlockEnd() {
        ...
        int len = sTest.lengthOfBlock();

        Statement emptyBlock = sRef.newInstance();
        Statement nestedTest = sTest.removeFromBlock(3);
        Statement nestedRef = sRef.removeFromBlock(3);
        sRef.addToBlock(len - 1, nestedRef);

        /*
         * The call
         */
        sTest.addToBlock(len - 1, nestedTest);
    ...
    public final void testLengthOfBlockEmpty() {
        /*
         * Setup. Notice statement4 is blank
         */
        Statement sTest = this.createFromFileTest("data/statement-sample4.bl");
        Statement sRef = this.createFromFileRef("data/statement-sample4.bl");
        int lengthRef = sRef.lengthOfBlock();
